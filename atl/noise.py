...
def calc_noise(
    ...
    """Old function for calculating noise. We know what it looks like now though!"""
    ...
    a, b, c = 50.2, 97.4, 92.9
    sys_limit = a + b * 10 ** (0.2 * (Tmag - 10)) + c * 10 ** (0.4 * (Tmag - 10))
    ...
    noise_sys = sys_limit / (1 * 10.0**6) / np.sqrt(exptime / 3600.0)
